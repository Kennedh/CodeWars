"""
A Discovery
One fine day while Farmer Arepo Tenaciously Labored at Turning the soil, he discovered a field that was scattered with
strange stone tablets. Noticing they were carved with letters in a square pattern, he wisely kept them in case some
might be special.
...
print(f"É Sator Square? {is_sator_square(tablet_true)}")
print(f"É Sator Square? {is_sator_square(tablet_false)}")