"""
Given a string and an array of indices, rearrange the characters of the string so that each character is placed at the
position specified by the corresponding index in the array.
...
def scramble(strng, array):
    dic = {b:a for a, b in zip(strng, array)}
