...
in Java/Kotlin and C#) of all variations for an observed PIN with a length of 1 to 8 digits. We could name the function
...
def get_pins(observed):
    ...
    possibilidades = [adjacentes[digito] for digito in observed]
    res = [a for a in product(*possibilidades)]
